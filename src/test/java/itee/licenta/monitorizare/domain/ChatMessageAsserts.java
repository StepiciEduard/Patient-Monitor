...
public class ChatMessageAsserts {
    ...
    public static void assertChatMessageUpdatableFieldsEquals(ChatMessage expected, ChatMessage actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getContextStartDate()).as("check contextStartDate").isEqualTo(expected.getContextStartDate()))
            .satisfies(a -> assertThat(a.getContextEndDate()).as("check contextEndDate").isEqualTo(expected.getContextEndDate()));
    }
