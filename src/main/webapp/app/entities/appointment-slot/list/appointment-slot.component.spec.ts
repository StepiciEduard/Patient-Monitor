...
import { sampleWithRequiredData } from '../appointment-slot.test-samples';
...
describe('AppointmentSlot Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.appointmentSlots()[0]).toEqual(expect.objectContaining({ id: 3453 }));
  });

  describe('trackId', () => {
    it('should forward to appointmentSlotService', () => {
      const entity = { id: 3453 };
      jest.spyOn(service, 'getAppointmentSlotIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAppointmentSlotIdentifier).toHaveBeenCalledWith(entity);
