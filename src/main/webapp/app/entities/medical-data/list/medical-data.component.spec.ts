...
import { sampleWithRequiredData } from '../medical-data.test-samples';
...
describe('MedicalData Management Component', () => {
  let comp: MedicalDataComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MedicalDataComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.medicalData()[0]).toEqual(expect.objectContaining({ id: 18207 }));
  });

  describe('trackId', () => {
    it('should forward to medicalDataService', () => {
      const entity = { id: 18207 };
      jest.spyOn(service, 'getMedicalDataIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMedicalDataIdentifier).toHaveBeenCalledWith(entity);
