...
import itee.licenta.monitorizare.service.ChatMessageService;
...
/**
 * REST controller for managing {@link itee.licenta.monitorizare.domain.ChatMessage}.
 */
@RestController
...
public class ChatMessageResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ChatMessageDTO>> getAllChatMessages(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
