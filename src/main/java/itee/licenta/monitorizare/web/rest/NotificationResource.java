...
import itee.licenta.monitorizare.service.NotificationQueryService;
import itee.licenta.monitorizare.service.NotificationService;
...
/**
 * REST controller for managing {@link itee.licenta.monitorizare.domain.Notification}.
 */
@RestController
...
public class NotificationResource {
    ...
    public ResponseEntity<List<NotificationDTO>> getAllNotifications(
        ...
        Page<NotificationDTO> page = notificationService.findAllForCurrentUser(pageable);
