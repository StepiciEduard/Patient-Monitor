...
/**
 * Service Implementation for managing {@link itee.licenta.monitorizare.domain.Notification}.
 */
@Service
@Transactional
public class NotificationService {
     ...
     * Each user only sees notifications where they are the recipient.
     */
    ...
    public Page<NotificationDTO> findAllForCurrentUser(Pageable pageable) {
        ...
        return notificationRepository.findByRecipientUserIsCurrentUserPaged(pageable).map(notificationMapper::toDto);
    }
