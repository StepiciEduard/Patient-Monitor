...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, itee.licenta.monitorizare.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, itee.licenta.monitorizare.repository.UserRepository.USERS_BY_EMAIL_CACHE);
